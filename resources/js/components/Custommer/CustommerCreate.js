...
class CustommerCreate extends Component {
    constructor(props) {
        super(props);
        this.state = {
            name: "",
        ...
        this.hendleUserCreate = this.hendleUserCreate.bind(this);
                        ...
                        <div className="col-md-6">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <form onSubmit={this.hendleUserCreate}>
...
export default CustommerCreate;
